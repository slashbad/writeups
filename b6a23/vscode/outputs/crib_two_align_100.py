...
cls = [
    ...
    ['*VRTQabT~7_E=s#$a<arpWafgpWbZXpWB{lCa', '{aKCSfZOZXpWB{lCa'],
    ['*VRTQabT~7_E7GUoWafgpWbZXpWB{lCa', 'roWeEL&aTVnBa3IXYbiO~VaFj%Zb<$coWZZXpWB{lCa', '
...
assert long.encrypt(flag.encode('gbk')).__eq__(format('28q+RB.C2cF9$2xUEJ*FGAP*|ls^5~)#1{
